...
class StartGameUseCase(
    ...
    private fun Room.startGameByHost(jwtToken: String): String {
        ...
        val startGameRequest = StartGameRequest(players.map { it.toStartGamePlayer() })

        return gameService.startGame(gameServerHost, jwtToken, startGameRequest).url
    }

    private fun Room.Player.toStartGamePlayer(): StartGamePlayer = StartGamePlayer(id.value, nickname)
}
