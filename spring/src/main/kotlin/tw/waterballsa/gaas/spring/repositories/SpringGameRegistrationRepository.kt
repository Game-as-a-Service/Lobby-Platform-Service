...
class SpringGameRegistrationRepository(
    ...
    override fun findById(gameRegistrationId: GameRegistrationId): GameRegistration? =
        gameRegistrationDAO.findById(gameRegistrationId.value).map(GameRegistrationData::toDomain).orElse(null)
}
